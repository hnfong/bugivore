from djangodev.contrib.messages import constants
from djangodev.contrib.messages.storage.fallback import FallbackStorage, \
    CookieStorage
from djangodev.contrib.messages.tests.base import BaseTest
from djangodev.contrib.messages.tests.cookie import set_cookie_data, \
    stored_cookie_messages_count
from djangodev.contrib.messages.tests.session import set_session_data, \
