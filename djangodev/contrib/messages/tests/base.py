...
from djangodev.contrib.messages.storage import default_storage, base
from djangodev.contrib.messages.storage.base import Message
from django.core.urlresolvers import reverse
from django.contrib.auth.models import User
from djangodev.contrib.messages.api import MessageFailure
...
class BaseTest(TestCase):
    ...
    urls = 'djangodev.contrib.messages.tests.urls'
    levels = {
    ...
    def test_full_request_response_cycle(self):
        ...
        show_url = reverse('djangodev.contrib.messages.tests.urls.show')
        for level in ('debug', 'info', 'success', 'warning', 'error'):
            add_url = reverse('djangodev.contrib.messages.tests.urls.add',
                              args=(level,))
